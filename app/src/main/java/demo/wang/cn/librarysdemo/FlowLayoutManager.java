...
/**
 * author : wangshuai Created on 2017/5/31
...
/*    private class FlowItem {
    ...
    public boolean canScrollVertically() {
        Log.i("test","first=="+mFirstVisiPos+" last=="+mLastVisiPos+"---"+(mFirstVisiPos != 0 || mLastVisiPos != getItemCount() - 1));
        return mFirstVisiPos != 0 || mLastVisiPos != getItemCount() - 1;
    }
